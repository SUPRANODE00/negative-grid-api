...
import type { ExporterOptions, ReadableStorage, UnixFSEntry, UnixFSRecursiveEntry } from '../index.ts';
/**
 ...
 * ```
 */
export declare function recursive(path: string | CID, blockstore: ReadableStorage, options?: ExporterOptions): AsyncGenerator<UnixFSRecursiveEntry, void, any>;
