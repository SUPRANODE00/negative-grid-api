 ...
 * into one buffer
 */
declare function toBuffer(source: Iterable<Uint8Array>): Uint8Array<ArrayBuffer>;
declare function toBuffer(source: Iterable<Uint8Array> | AsyncIterable<Uint8Array>): Promise<Uint8Array<ArrayBuffer>>;
